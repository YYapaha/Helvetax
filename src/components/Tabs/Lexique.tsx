...
const TERMS: Term[] = [
  ...
  },
  {
    ...
    detail: "Les résidents étrangers avec permis B paient l'impôt à la source : l'employeur retient directement le montant calculé selon des barèmes. Depuis 2021, ils peuvent demander une rectification ordinaire (TOU) pour faire valoir des déductions supplémentaires. Le seuil d'assujettissement obligatoire est de 120 000 CHF/an dans la plupart des cantons (500 000 CHF à Genève).",
  ...
  },
  {
    ...
    detail: "Les contribuables imposés à la source peuvent demander une taxation ordinaire ultérieure (TOU) pour déduire des frais non pris en compte (3a, frais pro, dons, frais médicaux…). Obligatoire si revenu > 120 000 CHF/an (seuil fédéral) — sauf à Genève où ce seuil est de 500 000 CHF. En-dessous du seuil, la TOU est facultative mais souvent avantageuse.",
